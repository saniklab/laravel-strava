...
[![Release](https://img.shields.io/github/release/saniklab/laravel-strava)](https://packagist.org/packages/saniklab/strava)
...
- [Strava Access Credentials](https://github.com/saniklab/strava#strava-access-credentials)
- [Installation](https://github.com/saniklab/strava#installation)
- [Publish Strava Config File](https://github.com/saniklab/strava#publish-strava-config-file)
- [Auto Discovery](https://github.com/saniklab/strava#auto-discovery)
  - [Provider](https://github.com/saniklab/strava#provider)
  - [Facade](https://github.com/saniklab/strava#alias--facade)
- [Usage](https://github.com/saniklab/strava#usage)
  - [Initialise Facade](https://github.com/saniklab/strava#use-strava-facade)
  - [Authenticate User](https://github.com/saniklab/strava#authenticate-user)
  - [Get Access Token](https://github.com/saniklab/strava#get-access-token)
  - [Access Token Expiry](https://github.com/saniklab/strava#access-token-expiry)
  - [Unauthenticate User](https://github.com/saniklab/strava#unauthenticate-user)
- [Available Methods](https://github.com/saniklab/strava#usage)
  - [Athlete Data](https://github.com/saniklab/strava#athelete-data)
  - [User Activities Data](https://github.com/saniklab/strava#user-activities-data)
  - [User Single Activity](https://github.com/saniklab/strava#user-single-activity)
  - [User Single Activity Stream](https://github.com/saniklab/strava#user-single-activity-stream)
  - [Activity Comments](https://github.com/saniklab/strava#activity-comments)
  - [Activity Kudos](https://github.com/saniklab/strava#activity-kudos)
  - [Activity Laps](https://github.com/saniklab/strava#activity-laps)
  - [Activity Zones](https://github.com/saniklab/strava#activity-zones)
  - [Update Activity](https://github.com/saniklab/strava#update-activity)
  - [Athlete Zones](https://github.com/saniklab/strava#athlete-zones)
  - [Athlete Stats](https://github.com/saniklab/strava#athlete-stats)
  - [Club](https://github.com/saniklab/strava#club)
  - [Club Members](https://github.com/saniklab/strava#club-members)
  - [Club Activities](https://github.com/saniklab/strava#club-activities)
  - [Club Admins](https://github.com/saniklab/strava#club-admins)
  - [Athlete Clubs](https://github.com/saniklab/strava#athlete-clubs)
  - [Gear](https://github.com/saniklab/strava#gear)
  - [Route](https://github.com/saniklab/strava#route)
  - [Athlete Routes](https://github.com/saniklab/strava#athlete-routes)
  - [Segment](https://github.com/saniklab/strava#segment)
  - [Segment Effort](https://github.com/saniklab/strava#segment-effort)
  - [Starred Segments](https://github.com/saniklab/strava#starred-segments)
- [Parameter Types](https://github.com/saniklab/strava#parameter-types)
- [Caching](https://github.com/saniklab/laravel-strava#caching)
- [Useful Links](https://github.com/saniklab/laravel-strava#useful-links)
...
```shell
composer require saniklab/strava
```
...
```shell
php artisan vendor:publish --provider="SanikLab\Strava\StravaServiceProvider"
```
...
```php
SanikLab\Strava\StravaServiceProvider::class,
```

#### Alias / Facade

```php
'Strava' => SanikLab\Strava\StravaFacade::class,
```
